...
## Compiling Demos
```bash
cd docs/templates/fsb-thesis/demo && pdflatex -interaction=nonstopmode demo_final.tex && pdflatex -interaction=nonstopmode demo_final.tex
cd docs/templates/fsb-seminar/demo && pdflatex -interaction=nonstopmode demo_final.tex && pdflatex -interaction=nonstopmode demo_final.tex
cd docs/templates/kx-paper/demo && pdflatex -interaction=nonstopmode demo_final.tex && pdflatex -interaction=nonstopmode demo_final.tex
```
